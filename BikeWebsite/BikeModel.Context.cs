...
namespace BikeWebsite
{
    ...
    public partial class DBEntities : DbContext
    {
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[DBEntities].[ufnGetAllCategories]()");
        }
    
        [DbFunction("DBEntities", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[DBEntities].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
